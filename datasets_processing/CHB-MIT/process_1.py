...
if __name__ == "__main__":
    ...
    parser  = argparse.ArgumentParser(description='Process CHB-MIT data')
    
    parser.add_argument('--signals_path', type=str, default="", help='Path to the data main directory')
    args = parser.parse_args()
    # PARAMETERS
    signals_path = args.signals_path # Path to the data main directory
    clean_path = os.path.join(signals_path, "clean_signals")  # Path where to store clean data
